...
<p align="left">
  <ul>
    <li>Currently  pursuing Btech in Computer Science and Enginerring from  JSS Academy of Technical Education Noida 🎓</li>
     <li>I have an interest in making web applications (MERN STACK),ML,  games, coding  etc 🎮</li>
      <li>    Loves to work on space and astronomy related tasks 💭</li>
        <li> Likes to code in C++,Python , javascript 💻</li>  
